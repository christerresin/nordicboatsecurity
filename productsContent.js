export const productsContent = [
  ...
  },
  {
    header: 'Webshop',
    contentSections: [
      'Våran webshop är under uppbyggnad men du är välkommen att kontakta oss (infoga länk) för prisförfrågan',
    ],
  },
  {
    header: '',
    contentSections: [
      'I vårt utbud finns idag videoövervakningsprodukter från Avigilon, GOST och HikVision. Vi är måna om att du även ska kunna använda dina övervakningskameror ombord, exempelvis som backkamera vid angöring i hamn eller varför inte föreviga er båttur eller fiskelycka!',
    ],
  },
];
